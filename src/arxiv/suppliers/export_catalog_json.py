        ...
        for row in _load_rows(db_path, sites):
            ...
            item = {
                ...
                "dimensions_cm": {
                    ...
                    "package_width": row.get("package_width_cm"),
                    "package_depth": row.get("package_depth_cm"),
                    "package_height": row.get("package_height_cm"),
                    "packed_weight_kg": row.get("packed_weight_kg"),
